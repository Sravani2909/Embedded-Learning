...
static long pcd_ioctl(struct file *filp,
                      unsigned int cmd,
                      unsigned long arg);
...
static long pcd_ioctl(struct file *filp,unsigned int cmd,unsigned long arg)
{
	switch(cmd){
		case LED_ON:
			led_status =1;
...
static int __init pcd_driver_init(void){
      ...
      device_pcd =device_create(class_pcd,NULL,device_number,NULL,"pcd_ioctl");
...
MODULE_DESCRIPTION("Ioctl function implementation");
